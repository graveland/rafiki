...
// ─── the pic-helpers → rafiki-helpers migration ────────────────────────────────

// writeLegacyHelpers plants a pre-rename pic-helpers install, standing in for
// either rafiki's own leftovers or pi-controller's live extension — the whole
...
// TestLegacyHelpers_NotRemovedByRemoveFlag: --remove uninstalls rafiki-helpers
