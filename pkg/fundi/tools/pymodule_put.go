...
type PyModuleStore interface {
	...
	// Delete soft-deletes the named module: a tombstone leaves the inventory
	// and is pruned from executors on the next sync; a later Put under the
	// same name restores it. Returns an error wrapping pymodules.ErrNotFound
