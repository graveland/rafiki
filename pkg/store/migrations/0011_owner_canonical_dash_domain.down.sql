-- Revert to 0008's owner canonicalization (the `-at-` rewrite only),
-- restoring both views exactly as 0008 defined them.

-- v_conversation selects explicit columns; CASCADE drops v_turn with it.
