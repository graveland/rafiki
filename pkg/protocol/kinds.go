...
// as distinct from rafiki, the friend that keeps the history. script is a
// child whose brain is a saved pymodule process instead of an LLM, talking
// to the daemon over its per-child Connect socket.
//
