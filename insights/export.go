...
type TranscriptTurn struct {
	Ordinal int
	Role    string
	Content json.RawMessage // verbatim content-block array

	Skills []string // skills invoked in this message (Skill tool_use / user /slash markers)
...
type Transcript struct {
	...
	AvailableSkills []string // catalog recovered from prefix_content, else union of invoked skills
}
